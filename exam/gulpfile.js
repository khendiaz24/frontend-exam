...
function scripts() {
  ...
  var plugins = src([    
    paths.scripts.src + '/lottie.js',
    paths.scripts.src + '/flickity.pkgd.min.js',
    paths.scripts.node + '/appear/dist/appear.js',
  ])
  ...
  var script = src([
    ...
    paths.scripts.src + '/carousel.js',
    paths.scripts.src + '/wave.js',
    paths.scripts.src + '/masked.js',
  ])
  .pipe(sourcemaps.init())
  .pipe(babel({
    "presets": ["@babel/env"]
  ...
  return bootstrap, plugins, script;
